...
profile_haos_installer() {
    ...
    kernel_addons=""
    modloop_sign="no"
    kernel_cmdline="modules=loop,squashfs,isofs,cdrom,sr_mod,sd-mod,usb-storage,uas,ahci,nvme,virtio_blk,virtio_scsi,virtio_pci,virtio_net,e1000,e1000e,igb,igc,ixgbe,i40e,ice,r8169,atlantic,alx,tg3,bnx2,bnx2x,qede,mlx4_en,mlx5_core,be2net,enic,sky2,skge,forcedeth,via-rhine,via-velocity,tulip,pcnet32,8139too,8139cp,sis900,natsemi,vmxnet3,r8152,asix,ax88179_178a,cdc_ether,smsc95xx,dm9601,mcs7830 alpine_dev=LABEL=HAOS-INSTLR console=tty1"

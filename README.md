...
The ISO is useful for VMs, Ventoy drives, or optical-style boot media. Unlike the USB created by the Windows app, the ISO does not contain a cached Home Assistant OS image, so it normally needs internet access during install.
